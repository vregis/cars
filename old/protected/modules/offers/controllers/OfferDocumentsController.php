...
class OfferDocumentsController extends Controller
{
	...
	public function actionAdd($id)
	{
        ...
        $model=new OfferDocuments;
        $model->offer_id = $id;
        
        if ($model->offer->owner_id != Yii::app()->user->id)
            throw new CHttpException(404,'The requested page does not exist.');

        if(isset($_POST['OfferDocuments']))
        {
            $model->attributes=$_POST['OfferDocuments'];
	...
	{   
        ...
        $model=new OfferDocuments('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['OfferDocuments']))
            $model->attributes=$_GET['OfferDocuments'];
        $model->offer_id = $id;
	 ...
	 * @return OfferDocuments the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=OfferDocuments::model()->findByPk($id);
		if($model===null)
			throw new CHttpException(404,'The requested page does not exist.');
		return $model;
	}
	 ...
	 * @param OfferDocuments $model the model to be validated
	 */
