...
class Offers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('category_id, title, description, owner_id, price_daily, price_hourly', 'required'),
			array('category_id, year, owner_id, status, type, views', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			...
			'publicOptions' => array(self::HAS_MANY, 'OfferOptions', 'offer_id', 'order' => '`order` ASC', 'condition' => '`visible` = 1'),
