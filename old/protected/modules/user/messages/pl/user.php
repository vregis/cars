...
return array(
	...
	'Logout' => 'Выйти',
	'Username' => 'Телефон',
	'Username or email' => 'Телефон или email',
	'username' => 'Телефон',
	'username or email' => 'Телефон или email',
	'Password' => 'Пароль',
	'password' => 'Пароль',
	'Remember me next time' => 'Запомнить меня',
	'Username is incorrect.' => 'Пользователь с таким номером не зарегистрирован.',
	'Email is incorrect.' => 'Пользователь с таким электроным адресом не зарегистрирован.',
	"This user's name already exists." => 'Пользователь с таким номером телефона уже существует.',
	...
	'Please activate you account go to {activation_url}' => 'Здравствуйте!<br /><br />Вы успешно зарегистрировались на сайте URCS.com.ua.<br /><br />Для активации аккаунта пожалуйста перейдите по следующей ссылке:<br />{activation_url}.',
	...
	'Incorrect username (length between 3 and 20 characters).' => 'Длина номера телефона пользователя от 3 до 20 символов.',
	"Incorrect symbols (A-z0-9)." => 'В номере телефона пользователя допускаются только цифры.',
	...
	'Please enter your login or email addres.' => 'Пожалуйста, введите Ваш номер телефона или адрес электронной почты.',
	'Incorrect recovery link.' => 'Неправильная ссылка восстановления пароля.',
	...
	'Active' => 'Активирован',
	'Banned' => 'Заблокирован',
	'Please fill out the following form with your login credentials:' => 'Пожалуйста, заполните следующую форму с вашими данными для входа:',
	'Fields with <span class="required">*</span> are required.' => 'Поля, отмеченные <span class="required">*</span>, обязательны для заполнения.',
	'List User' => 'Каталог пользователей',
	'Edit' => 'Редактировать',
	...
	'Not visited' => 'Не входил',
        'You have requested the password recovery site {site_name}. To receive a new password, go to {activation_url}.' => 'Здравствуйте!<br /><br />Вы запросили восстановление пароля на сайте {site_name}.<br /><br />Для того, чтобы получить новый пароль, перейдите на <br /> {activation_url}.',
);
