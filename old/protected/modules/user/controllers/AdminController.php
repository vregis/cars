...
class AdminController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','create','update','getData','getAddressesData'),
	...
	public function actionGetData($q)
	{
		$raw_data = Profile::model()->findAll(array(
            'condition' => '`firstname` LIKE :q OR `lastname` LIKE :q',
            'params' => array(':q' => '%'.$q.'%'),
        ));
	...
	/**
	 * Return getListData array by user id
	 * @return Array
	 */
	public function actionGetAddressesData($user_id)
	{
		$raw_data = ShippingAddresses::model()->findAll(array(
            'condition' => '`user_id` = :user_id',
            'params' => array(':user_id' => $user_id),
            'order' => '`date_created` DESC',
        ));
        $data_list = CHtml::listData($raw_data, 'id', function($data) {return $data->fullAddress;});
