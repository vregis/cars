...
class beGridView extends CGridView
{    
	...
	public $itemsCssClass='table table-striped table-bordered table-hover dataTables-example';
    
	public $pagerCssClass='pagination';
    
	public $template='{items}<div class="row">{summary}{pager}</div>';
    
	public $pager=array('class'=>'application.components.widgets.beLinkPager');
    
    public $htmlOptions = array('class'=>'grid-view');
    
	public $summaryText='Элементы {start}&ndash;{end} из {count}.';
