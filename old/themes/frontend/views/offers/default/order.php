    ...
    <div class="row">
        <div class="col-xs-12 col-sm-3">
            <div class="offer-view-lite">
                ...
                <br />
                <p class="offer-price"><?= $this->formatPrice($model->offer->price_hourly); ?> <small class="text-muted thin">/ <?= Yii::t('app', 'hour') ?></small></p>
                <p class="offer-price"><?= $this->formatPrice($model->offer->price_daily); ?> <small class="text-muted thin">/ <?= Yii::t('app', 'day') ?></small></p>
            </div>
        </div>
        <div class="col-xs-12 col-sm-9">    
            <?php $form=$this->beginWidget('CActiveForm', array(
                ...
                <div class="form-group">
                    <div class="checkbox">
                        <?php echo CHtml::checkBoxList('OfferOptions', $a_options, CHtml::listData($model->offer->publicOptions, 'id', 'title')); ?>
                    </div>
                </div>
                <?php } ?>
