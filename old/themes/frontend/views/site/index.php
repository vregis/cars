        ...
        <div id="home-search">
            <div id="home-search-bg">
                <div class="home-search-cover" style="background-image: url(<?= SiteVars::v('HOME_PROMO_GROUND') ?>);">
                    <a href="/s?t=1">
                        <video muted loop>
                            <source src="resources/articles/home-video-1.mp4" type="video/mp4">
                        </video>
                    </a>
                </div>
                <div class="home-search-cover hidden-xs" style="background-image: url(<?= SiteVars::v('HOME_PROMO_WATER') ?>);">
                    <a href="/s?t=2">
                        <video muted loop>
                            <source src="resources/articles/home-video-2.mp4" type="video/mp4">
                        </video>
                    </a>
                </div>
        ...
        <!-- Top Promo -->   
        <div class="container">                        
            <div class="row info-block home-features">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <h2 class="text-center half-header">Rent for travelers</h2>
                    <?= CHtml::image(Yii::app()->theme->baseUrl.'/img/home-feature-1.jpg', '', array('class' => 'img-responsive')) ?>
                    <p class="text-center text-muted">Earn on items you don’t use, renting them for travelers and tourists.</p>                    
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <h2 class="text-center half-header">Secure payments</h2>
                    <?= CHtml::image(Yii::app()->theme->baseUrl.'/img/home-feature-2.jpg', '', array('class' => 'img-responsive')) ?>
                    <p class="text-center text-muted">Earn on items you don’t use, renting them for travelers and tourists.</p>                    
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <h2 class="text-center half-header">Guarantees</h2>
                    <?= CHtml::image(Yii::app()->theme->baseUrl.'/img/home-feature-3.jpg', '', array('class' => 'img-responsive')) ?>
                    <p class="text-center text-muted">Earn on items you don’t use, renting them for travelers and tourists.</p>                    
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <h2 class="text-center half-header">Works worldwide</h2>
                    <?= CHtml::image(Yii::app()->theme->baseUrl.'/img/home-feature-4.jpg', '', array('class' => 'img-responsive')) ?>
                    <p class="text-center text-muted">Earn on items you don’t use, renting them for travelers and tourists.</p>                    
                </div>
            </div>
        </div>
