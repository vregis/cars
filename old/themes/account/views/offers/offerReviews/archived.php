<?php
    $this->pageTitle = Yii::t('app', 'Submitted Reviews').' | '.Yii::app()->name;

    $this->breadcrumbs=array(
        Yii::t('app', 'Submitted Reviews')
    );
?>

    <div class="account-content">
        <h3><?= Yii::t('app', 'Submitted Reviews') ?></h3>
        
        <?php
        $this->widget('application.components.widgets.feGridView', array(
            'dataProvider'=>$model->reviewsSearch(true),
