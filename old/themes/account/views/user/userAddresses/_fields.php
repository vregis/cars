    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model,'country_id',ListCountries::model()->listData,array('class'=>'form-control', 'empty'=>Yii::t('app', 'Select country...'), 'id'=>'field-country-id')); ?>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model,'province_id',$provinces_list,array(
                    'class'=>'form-control', 
                    'empty'=>Yii::t('app', 'Select state/province...'), 
