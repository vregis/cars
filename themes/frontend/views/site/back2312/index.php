                ...
                <div class="row text-left">
                    <div class="col-xs-12 col-md-8 col-md-offset-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="c" id="home-search-input-category" placeholder="<?= Yii::t('app', 'Category, Auto') ?>" autocomplete="off">
                            <span class="input-group-addon  hidden-xs"><?= Yii::t('app', 'String') ?></span>
                            <input type="text" name="a" id="home-search-input-string" placeholder="<?= Yii::t('app', 'Paris, France') ?>" autocomplete="off">
                            <a href="#" class="btn-submit"><i class="fa fa-map-o"></i></a>
                        </div>
