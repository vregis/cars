...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'review_id',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-10">
            <?php echo $form->textField($model,'review_id'); ?>
            <span class="help-block m-b-none"><?php echo $form->error($model,'review_id'); ?></span>
        </div>
    </div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'author_id',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-10">
