	...
	public function run()
        {
            ...
            $attributes_list = $this->attribute;
            if (isset($attributes_list['autofocus']))
                $text_options = array('id' => $id.'_combobox', 'autofocus' => 'autofocus', 'class'=>'combobox_select');
            else
                $text_options = array('id' => $id.'_combobox', 'class'=>'combobox_select');
            
            echo CHtml::textField(null,($this->hasModel()?($data[CHtml::resolveValue($this->model,$this->attribute)]):$data[$this->value]),$text_options);
            //echo CHtml::textField(null,$data[$this->value],array('id'=>$id.'_combobox'));
