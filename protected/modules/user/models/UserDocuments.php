...
class UserDocuments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, is_approved, approved_by', 'numerical', 'integerOnly'=>true),
			array('filename', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, user_id, title, date_uploaded, is_approved, approved_by, date_approved', 'safe'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'is_approved' => 'Документ подтвержден',
			'approved_by' => 'Автор подтверждения',
			'date_approved' => 'Дата подтверждения',
		);
	}
	...
	public function search()
	{
        ...
        $sort = new CSort;
        $sort->defaultOrder = '`date_uploaded` DESC';
        //$sort->multiSort = true;
