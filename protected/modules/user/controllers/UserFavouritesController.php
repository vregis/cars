...
class UserFavouritesController extends Controller
{
	...
	public function actionIndex()
	{
        ...
        $model=new UserFavourites('frontendSearch');
	...
	{   
        ...
        $model=new UserFavourites('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['UserFavourites']))
            $model->attributes=$_GET['UserFavourites'];
        $model->user_id = $id;
        ...
        if (isset($_GET['ajax'])) {
            ...
            $form_model = new UserFavourites;
            $form_model->user_id = $id;

            if(isset($_POST['UserFavourites']))
            {
                $form_model->attributes = $_POST['UserFavourites'];
	...
	{
		$model=UserFavourites::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UserFavourites $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='user-favourites-form')
		{
