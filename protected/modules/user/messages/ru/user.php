...
return array(
	...
	'Please activate you account go to {activation_url}' => 'Здравствуйте!<br /><br />Вы успешно зарегистрировались на сайте GetUpWay.com.<br /><br />Для активации аккаунта пожалуйста перейдите по следующей ссылке:<br />{activation_url}.',
	...
	'Incorrect username (length between 3 and 20 characters).' => 'Длина логина пользователя от 3 до 20 символов.',
	"Incorrect symbols (A-z0-9)." => 'В логине пользователя допускаются только цифры.',
