...
class Orders extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('offer_id, client_id', 'required'),
			array('offer_id, price_daily, price_type', 'fixed'),
			array('offer_id, client_id, price_type, status', 'numerical', 'integerOnly'=>true),
			array('total_cost, amount', 'numerical'),
            array('paypal_id', 'email'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, offer_id, client_id, address_from, address_to, price_daily, price_type, release_code, date_created, date_changed, status, notes, canceled_by, canceled_date, cancel_approved, time_to_prepare, date_for_real, dates_split, main_option_id', 'safe'),
		);
	}
