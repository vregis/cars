...
class WithdrawsController extends Controller
{
	...
	public function actionCreate()
	{
        ...
        {
            $model->attributes=$_POST['Withdraws'];
	...
	{   
        ...
        $model=new Withdraws('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['Withdraws']))
            $model->attributes=$_GET['Withdraws'];
	...
	{
		$model=Withdraws::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Withdraws $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='withdraws-form')
		{
